...
import com.cl.news.modules.news.NewsPagerFragment;
import com.cl.news.modules.photo.PhotoPagerFragment;
import com.cl.news.modules.video.VideoPagerFragment;
...
public class MainActivity extends AppCompatActivity {
    ...
    private NewsPagerFragment newsFragment;
    private VideoPagerFragment videoFragment;
    private PhotoPagerFragment photoFragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       navigationView= (NavigationView) findViewById(R.id.activity_main_navigationview);
        ...
        bottomNavigationView= (BottomNavigationView) findViewById(R.id.activity_main_navigation);
          ...
          newsFragment= NewsPagerFragment.getInstance();
          videoFragment= VideoPagerFragment.getInstance();
          photoFragment = PhotoPagerFragment.getInstance();
