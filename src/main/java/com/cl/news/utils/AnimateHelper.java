...
public class AnimateHelper {
    ...
    public static  void doHeartBeat(View view,int duration){
        ...
        set.playTogether(ObjectAnimator.ofFloat(view,"scaleX",1.0f, 1.4f, 0.9f, 1.0f),ObjectAnimator.ofFloat(view,"scaleY",1.0f, 1.4f, 0.9f, 1.0f));
          set.setDuration(duration);
        set.start();
    }

    public static Animator doHappyDump(View view,int jumpHeight,int duration){
